 ...
 */
var HexaSkill = "HexaLeapMotSkill";
...
function reg_button_ev_hdl(document)
{
    ...
    document.getElementById("gorect_n").onclick = function()
    {
        let msg = "gorect_n";

        hexa_send_data(msg);
        hexa_out.innerHTML = "Hexa walks rectangle - Decrement Distance";
    }
    document.getElementById("gorect_p").onclick = function()
    {
        let msg = "gorect_p";

        hexa_send_data(msg);
        hexa_out.innerHTML = "Hexa walks rectangle - Increment Distance";
    }
    document.getElementById("gorect2_n").onclick = function()
    {
        let msg = "gorect2_n";

        hexa_send_data(msg);
        hexa_out.innerHTML = "Hexa walks rectangle - Methode 2 - Decrement Distance";
    }
    document.getElementById("gorect2_p").onclick = function()
    {
        let msg = "gorect2_p";

        hexa_send_data(msg);
        hexa_out.innerHTML = "Hexa walks rectangle - Methode 2 - Increment Distance";
    }
}
