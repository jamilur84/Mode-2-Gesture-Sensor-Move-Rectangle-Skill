...
func NewSkill() skill.Interface {
	return &HexaLeapMotSkill{
		stop: make(chan bool),
	}
}

// Move the robot to the stand-up position
func (d *HexaLeapMotSkill) standup() {
...
func (d *HexaLeapMotSkill) standdown() {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) walkPathRectangle(increment int) {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) walkPathRectangle2(increment int) {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) walkPathCircle() {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) moveLeg(leg_idx int) {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) walk(direction float64) {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) startSkill1() {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) startSkill2() {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) startSkill3() {
	// Set the is busy flag to true
	d.is_busy = true
...
func (d *HexaLeapMotSkill) OnStart() {
...
func (d *HexaLeapMotSkill) OnDisconnect() {
